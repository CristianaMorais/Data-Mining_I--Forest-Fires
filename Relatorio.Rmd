...
```{r,include= FALSE}
aux <- fires_train %>% select(c(2,3,6,7,8,9,11,12,13,16,18)) # com lat e lon
aux2 <- fires_test %>% select(c(2,3,6,7,8,9,11,12,13,17)) #com lat e lon 
...
```{r}
modelo
varImpPlot(modelo, main = "Feature Relevance Scores")
```
